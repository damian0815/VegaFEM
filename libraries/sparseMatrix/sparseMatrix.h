...
public:
	...
	void AddSparseEntry(int row, int denseJ); // open a new entry in the sparse matrix
	void AddSparseBlock3x3Entry(int startRow, int startDenseJ); // same as calling AddSparseEntry in a 3x3 block between (startRow,startDenseJ) and (startRow+2,startDenseJ+2)
...
protected:
	...
	bool diagonalIndicesOutOfDate;
	bool transposedIndicesOutOfDate;
