...
public:
    ...
    void AppendEntries(const SparseMatrixOutline& other);
    ...
    inline int Getn() const { return columnEntries.size(); } // get number of rows
    inline int GetNumRows() const { return Getn(); } // get number of rows
